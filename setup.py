...
with sqlite3.connect("database.db") as connection: # Get a connection to the database file
	...
	cursor.execute('''
		...
		(
			...
			battle_sprite_path TEXT NOT NULL,
			holding TEXT,
			attack INT NOT NULL,
	...
	cursor.execute('INSERT INTO item (item_id, item_name, item_display_name, color, times_used, description, icon, type_id) VALUES (1, "health_potion", "Health Potion", "ffbbaa", 0, "A spray-type medicine for wounds. It restores the HP of one Pokémon by just 20 points. ", "fa-solid fa-flask", 0)')
	cursor.execute('INSERT INTO item (item_id, item_name, item_display_name, color, times_used, description, icon, type_id) VALUES (2, "speed_potion", "Speed Potion", "aabbff", 0, "An item that raises the Speed stat of a Pokémon in battle. It wears off if the Pokémon is withdrawn. ", "fa-solid fa-flask", 0)')
	cursor.execute('INSERT INTO item (item_id, item_name, item_display_name, color, times_used, description, icon, type_id) VALUES (0, "regular_ball", "Regular Ball", "ff8888", 0, "The Classic Pokemon Ball! Used for catching Pokemon!", "fa-solid fa-bullseye", 1)')
	cursor.execute('INSERT INTO item (item_id, item_name, item_display_name, color, times_used, description, icon, type_id) VALUES (3, "leve_stone", "Level Stone", "FFFFFF", 0, "Automatically levels up a pokemon!", "fa-regular fa-gem", 2)')
	...
	cursor.execute('''
		INSERT INTO pokemon
			(pokemon_id, p_name, health, hype, sprite_path, battle_sprite_path, holding, attack, defense, speed, caught_date, team_id, description)
		VALUES
			(0, "pikachu", 100, 100, "/static/pikachu_icon.png","/static/pikachu_battle_sprite.png", "Fire Stone", 12, 34, 15, "11/18/2022", 0, "It lives in forests with others. It stores electricity in the pouches on its cheeks.")
		''')

	cursor.execute('''
		INSERT INTO pokemon
			(pokemon_id, p_name, health, hype, sprite_path, battle_sprite_path, attack, defense, speed, caught_date, team_id, description)
		VALUES
			(1, "arceus", 100, 1000, "/static/arceus_icon.png","/static/arceus_battle_sprite.png", 100, 25, 50, "11/22/2022", 0, "It is described in mythology as the Pokémon that shaped the universe with its 1,000 arms.")
		''')
	...
	cursor.execute('''
		INSERT INTO pokemon
			(pokemon_id, p_name, health, hype, sprite_path, battle_sprite_path, attack, defense, speed, caught_date, team_id, description)
		VALUES
			(2, "bidoof", 20, 50, "/static/bidoof_icon.png","/static/bidoof_battle_sprite.png", 200, 0, 0, "11/21/2022", 0, "With nerves of steel, nothing can perturb it. It is more agile and active than it appears.")
		''')
